// Окно согласия при первом запуске. Пока не принято — аналитика молчит и не уходит
// ни одного запроса к /api/auth и /api/social (CONTRACT.md D31).
    ...
    <div className={'modal' + (open ? ' open' : '')} role="dialog" aria-modal="true" aria-labelledby="consent-h">
      ...
      <div className="modal__c">
        ...
        <ul className="modal__l">
          ...
          {/* На адресах вузов вуз задан самим адресом и в браузере не хранится. */}
